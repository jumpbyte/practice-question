...
import static com.daojia.suyun.driver.common.check.CheckResultCodeEnum.STR_LENGTH_GT_FAIL;
...
public class StrLengthGtRuler extends BaseRuler<String> {
    ...
    public StrLengthGtRuler(int norm, int failCode, String failDesc) {
