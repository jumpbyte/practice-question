...
import static com.daojia.suyun.driver.common.check.CheckResultCodeEnum.STR_LENGTH_GTE_FAIL;
...
public class StrLengthGteRuler extends BaseRuler<String> {
    ...
    public StrLengthGteRuler(int norm, int failCode, String failDesc) {
